...
use crate::systems::load_state::animation_asset_prep::controllable_entity_animation_prep::attach_controlled_animations_to_controllable_entities;
use crate::systems::load_state::animation_asset_prep::environmental_entity_animation_prep::attach_overlay_animations_to_environmental_entities;
...
use crate::systems::load_state::spawn_environmental_entity::spawn_environmental_entity;
    ...
    fn build(&self, app: &mut App) {
        ...
        .add_systems(
            ...
            (
                ...
                spawn_environmental_entity.after(spawn_controllable_entity),
                attach_overlay_animations_to_environmental_entities
                    .after(spawn_environmental_entity),
